...
import { n as addEventListener } from "./useValueAsRef-ClMqfIbJ.js";
import { a as FOCUSABLE_ATTRIBUTE, l as lowerUserAgent } from "./constants-BLVe3d4Y.js";
import { A as isReactEvent, F as apple, O as isClickLikeEvent, o as isElementVisible } from "./inertValue-D2HhRy3t.js";
import { i as ownerDocument, n as contains, r as getTarget, t as activeElement } from "./shadowDom-D9tlEle0.js";
import { c as NOOP, i as isReactVersionAtLeast, l as useRefWithInit, s as EMPTY_OBJECT, t as useRenderElement } from "./useRenderElement-DegcFfl9.js";
import { n as useTimeout, t as Timeout } from "./useTimeout-CmPZ6POT.js";
import { i as isRootElement, n as isEventTargetWithin } from "./element-BeZRMAuk.js";
import { D as outsidePress, E as none, F as triggerPress, P as triggerHover, d as escapeKey, t as createChangeEventDetails } from "./createBaseUIEventDetails-Z3Dw2aqZ.js";
...
import { a as useTransitionStatus, n as transitionStatusMapping, r as useOpenChangeComplete, t as TransitionStatusDataAttributes } from "./stateAttributesMapping-Br1kh8b0.js";
...
//#endregion
export { getTabbableBeforeElement as $, useFloatingNodeId as A, DROPDOWN_COLLISION_AVOIDANCE as B, Store as C, useDismiss as D, fastComponentRef as E, useFloatingPortalNode as F, getNodeAncestors as G, POPUP_COLLISION_AVOIDANCE as H, usePortalContext as I, enableFocusInside as J, getNodeChildren as K, BASE_UI_SWIPE_IGNORE_SELECTOR as L, useFloatingTree as M, FloatingTreeStore as N, FloatingNode as O, FloatingPortal as P, getTabbableAfterElement as Q, CLICK_TRIGGER_IDENTIFIER as R, ReactStore as S, fastComponent as T, ownerVisuallyHidden as U, LEGACY_SWIPE_IGNORE_SELECTOR as V, createAttribute as W, getNextTabbable as X, focusable as Y, getPreviousTabbable as Z, usePopupRootSync as _, triggerOpenStateMapping as a, voiceOver as at, useSyncedFloatingRootContext as b, PopupHandleAttachment as c, createDefaultInitialFocus as d, isOutsideEvent as et, setPopupOpenState as f, usePopupRootStore as g, usePopupInteractionProps as h, pressableTriggerOpenStateMapping as i, mergeCleanups as it, useFloatingParentNodeId as j, FloatingTree as k, applyPopupOpenChange as l, useOpenStateTransitions as m, popupStateMapping as n, tabbable as nt, PopupTriggerMap as o, gecko as ot, useImplicitActiveTrigger as p, disableFocusInside as q, popupTransitionStateMapping as r, FocusGuard as rt, FOCUSABLE_POPUP_PROPS as s, webkit as st, CommonPopupDataAttributes as t, isTabbable as tt, attachPreventUnmountOnClose as u, useTriggerDataForwarding as v, useStore as w, FloatingRootStore as x, useTriggerRegistration as y, DISABLED_TRANSITIONS_STYLE as z };
