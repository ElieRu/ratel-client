...
`);
var satelliteAndMissingProxyUrlAndDomain = createErrorMessage(`Missing domain and proxyUrl. A satellite application needs to specify a domain or a proxyUrl`);
...
//#endregion
export { resolveAuthState as A, isTruthy as B, LEGACY_DEV_INSTANCE_SUFFIXES as C, STAGING_API_URL as D, PROD_API_URL as E, isClerkAPIResponseError as F, noLoaderArgsPassedInGetAuth as G, invalidClerkStatePropError as H, parseError as I, satelliteAndMissingProxyUrlAndDomain as J, noSecretKeyError as K, ClerkError as L, validateReverificationConfig as M, ClerkAPIResponseError as N, STAGING_ENV_SUFFIXES as O, buildErrorThrower as P, ClerkRuntimeError as R, isomorphicAtob as S, LOCAL_ENV_SUFFIXES as T, invalidRootLoaderCallbackReturn as U, getEnvVariable as V, noClerkStateError as W, satelliteAndMissingSignInUrl as Y, getCookieSuffix as _, getAutoProxyUrlFromEnvironment as a, isDevelopmentFromSecretKey as b, isValidProxyUrl as c, handleValueOrFn as d, TelemetryCollector as f, createDevOrStagingUrlCache as g, isDevelopmentEnvironment as h, isLegacyDevAccountPortalOrigin as i, splitByScope as j, createCheckAuthorization as k, proxyUrlToAbsoluteURL as l, isAutomatedEnvironment as m, addClerkPrefix as n, isHttpOrHttps as o, eventMethodCalled as p, publishableKeyMissingErrorInSpaMode as q, isCurrentDevAccountPortalOrigin as r, isProxyUrlRelative as s, deprecated as t, retry as u, getSuffixedCookieName as v, LOCAL_API_URL as w, parsePublishableKey as x, isDevelopmentFromPublishableKey as y, getPublicEnvVariables as z };
