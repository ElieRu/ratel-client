...
import { t as require_with_selector } from "./with-selector-m9dUj709.js";
...
function constructColumn(table, columnDef, depth, parent) {
	...
	if (!id) throw new Error(resolvedColumnDef.accessorFn ? `coreColumnsFeature require an id when using an accessorFn` : `coreColumnsFeature require an id when using a non-string header`);
...
function table_getRow(table, rowId, searchAll) {
	...
	if (!row) {
		...
		if (!row) throw new Error(`getRow could not find row with ID: ${rowId}`);
	}
	return row;
}
//#endregion
...
//#endregion
//#region node_modules/@tanstack/table-core/dist/core/table/coreTablesFeature.js
/**
...
//#endregion
//#region node_modules/@tanstack/table-core/dist/helpers/columnHelper.js
/**
...
//#endregion
//#region node_modules/@tanstack/table-core/dist/helpers/metaHelper.js
/**
...
//#endregion
//#region node_modules/@tanstack/table-core/dist/helpers/tableOptions.js
/**
...
//#endregion
//#region node_modules/@tanstack/react-table/dist/createTableHook.js
var sharedTableContext = (0, import_react.createContext)(null);
var sharedCellContext = (0, import_react.createContext)(null);
var sharedHeaderContext = (0, import_react.createContext)(null);
/**
...
function createTableHook({ tableComponents, cellComponents, headerComponents, tableContext = sharedTableContext, cellContext = sharedCellContext, headerContext = sharedHeaderContext, ...defaultTableOptions }) {
	...
	*/
	function useTableContext() {
		const table = (0, import_react.useContext)(TableContext);
	...
	*/
	function useCellContext() {
		const cell = (0, import_react.useContext)(CellContext);
	...
	*/
	function useHeaderContext() {
		const header = (0, import_react.useContext)(HeaderContext);
	...
	*/
	function CellFlexRender() {
		...
		return /* @__PURE__ */ import_react.createElement(FlexRender, { cell });
	}
	/**
	...
	*/
	function HeaderFlexRender() {
		const header = useHeaderContext();
		return /* @__PURE__ */ import_react.createElement(FlexRender, { header });
	}
	/**
	...
	*/
	function FooterFlexRender() {
		const header = useHeaderContext();
		return /* @__PURE__ */ import_react.createElement(FlexRender, { footer: header });
	}
	/**
	...
	*/
	function useAppTable(tableOptions, selector) {
		...
		const AppTable = (0, import_react.useMemo)(() => {
			function AppTableImpl(props) {
				const { children, selector: appTableSelector } = props;
				const currentTable = tableRef.current;
				return /* @__PURE__ */ import_react.createElement(TableContext.Provider, { value: currentTable }, appTableSelector ? /* @__PURE__ */ import_react.createElement(currentTable.Subscribe, { selector: appTableSelector }, (state) => children(state)) : children);
			}
			return AppTableImpl;
		}, []);
		const AppCell = (0, import_react.useMemo)(() => {
			function AppCellImpl(props) {
				...
				return /* @__PURE__ */ import_react.createElement(CellContext.Provider, { value: cell }, appCellSelector ? /* @__PURE__ */ import_react.createElement(currentTable.Subscribe, { selector: appCellSelector }, (state) => children(extendedCell, state)) : children(extendedCell));
			}
			return AppCellImpl;
		}, []);
		const AppHeader = (0, import_react.useMemo)(() => {
			function AppHeaderImpl(props) {
				...
				return /* @__PURE__ */ import_react.createElement(HeaderContext.Provider, { value: header }, appHeaderSelector ? /* @__PURE__ */ import_react.createElement(currentTable.Subscribe, { selector: appHeaderSelector }, (state) => children(extendedHeader, state)) : children(extendedHeader));
			}
			return AppHeaderImpl;
		}, []);
		const AppFooter = (0, import_react.useMemo)(() => {
			function AppFooterImpl(props) {
				...
				return /* @__PURE__ */ import_react.createElement(HeaderContext.Provider, { value: header }, appFooterSelector ? /* @__PURE__ */ import_react.createElement(currentTable.Subscribe, { selector: appFooterSelector }, (state) => children(extendedHeader, state)) : children(extendedHeader));
			}
...
//#endregion
//#region node_modules/@tanstack/react-table/dist/createTableHookContexts.js
/**
...
function createTableHookContexts() {
	const tableContext = (0, import_react.createContext)(null);
	const cellContext = (0, import_react.createContext)(null);
	const headerContext = (0, import_react.createContext)(null);
	/**
