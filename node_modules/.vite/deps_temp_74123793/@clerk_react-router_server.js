import { r as __toESM$1, t as __commonJSMin } from "./rolldown-runtime-DC62tzP2.js";
import { B as isTruthy, C as LEGACY_DEV_INSTANCE_SUFFIXES, D as STAGING_API_URL, E as PROD_API_URL, F as isClerkAPIResponseError, G as noLoaderArgsPassedInGetAuth, I as parseError, J as satelliteAndMissingProxyUrlAndDomain, K as noSecretKeyError, L as ClerkError, N as ClerkAPIResponseError, O as STAGING_ENV_SUFFIXES, P as buildErrorThrower, S as isomorphicAtob, T as LOCAL_ENV_SUFFIXES, U as invalidRootLoaderCallbackReturn, V as getEnvVariable, Y as satelliteAndMissingSignInUrl, _ as getCookieSuffix, a as getAutoProxyUrlFromEnvironment, b as isDevelopmentFromSecretKey, d as handleValueOrFn, f as TelemetryCollector, g as createDevOrStagingUrlCache, h as isDevelopmentEnvironment, i as isLegacyDevAccountPortalOrigin, j as splitByScope, k as createCheckAuthorization, m as isAutomatedEnvironment, o as isHttpOrHttps, r as isCurrentDevAccountPortalOrigin, s as isProxyUrlRelative, t as deprecated, u as retry, v as getSuffixedCookieName, w as LOCAL_API_URL, x as parsePublishableKey, y as isDevelopmentFromPublishableKey, z as getPublicEnvVariables } from "./deprecated-Czuyvf0A.js";
import { vn as createContext } from "./development-VnGdt2rT.js";
...
//#endregion
//#region node_modules/@clerk/react-router/dist/utils/feature-flags.js
...
//#endregion
//#region node_modules/@clerk/backend/dist/chunk-R4AMSIE3.mjs
var require_dist$1 = __commonJS({ "../../node_modules/.pnpm/cookie@1.1.1/node_modules/cookie/dist/index.js"(exports) {
	"use strict";
...
function validateIdempotencyKey(idempotencyKey) {
	if (idempotencyKey !== void 0 && (typeof idempotencyKey !== "string" || !idempotencyKeyPattern.test(idempotencyKey))) throw new Error("Idempotency key must contain only ASCII letters, digits, underscores, and hyphens and cannot exceed 255 characters.");
}
...
var EmailApi = class extends AbstractAPI {
	...
	*/
	async createBatch(messages) {
		if (messages.length < 1 || messages.length > 100) throw new Error("A batch must contain between 1 and 100 messages.");
		for (const message of messages) validateIdempotencyKey(message.idempotencyKey);
		return (await this.request({
			method: "POST",
			path: `${basePath11}/batch`,
			bodyParams: { messages: messages.map(({ idempotencyKey, ...params }) => ({
				...emailBody(params),
				...idempotencyKey !== void 0 ? { idempotency_key: idempotencyKey } : {}
			})) }
		})).map((result) => result.email ? {
			index: result.index,
			email: Email.fromJSON(result.email),
...
var authenticateRequest = (async (request, options) => {
	...
	async function authenticateAnyRequestWithTokenInHeader() {
		...
		if (hasNonSessionJwtCategory(tokenInHeader)) return signedOut({
			tokenType: TokenType.SessionToken,
			authenticateContext,
			reason: AuthErrorReason.TokenTypeMismatch,
			message: ""
...
//#endregion
//#region node_modules/@clerk/react-router/dist/server/loadOptions.js
...
//#endregion
//#region node_modules/@clerk/backend/dist/index.mjs
...
//#endregion
//#region node_modules/@clerk/react-router/dist/server/clerkClient.js
var clerkClient = (args, overrides = {}) => {
	...
	return createClerkClient({
		...
		publishableKey,
		machineSecretKey,
		userAgent: `@clerk/react-router@3.6.24`
	});
};
//#endregion
...
//#endregion
//#region node_modules/@clerk/react-router/dist/server/keyless/fileStorage.js
...
function createFileStorage(options = {}) {
	...
	return createNodeFileStorage(import_browser_external_node_fs, import_browser_external_node_path, {
		cwd,
		frameworkPackageName: "@clerk/react-router"
	});
}
//#endregion
//#region node_modules/@clerk/react-router/dist/server/keyless/index.js
...
//#endregion
//#region node_modules/@clerk/react-router/dist/server/keyless/utils.js
/**
* Resolves Clerk keys, falling back to keyless mode in development if configured keys are missing.
*/
async function resolveKeysWithKeylessFallback(configuredPublishableKey, configuredSecretKey, args, options) {
	return resolveKeysWithKeylessFallback$1(configuredPublishableKey, configuredSecretKey, await keyless(args, options), canUseKeyless);
}
//#endregion
...
//#endregion
//#region node_modules/@clerk/react-router/dist/server/clerkMiddleware.js
...
var injectRequestStateIntoResponse = async (response, requestState, context, additionalStateOptions = {}, includeClerkHeaders = false) => {
...
//#endregion
//#region node_modules/@clerk/react-router/dist/server/getAuth.js
var getAuth = (async (args, opts) => {
	if (!args || args && (!args.request || !args.context)) throw new Error(noLoaderArgsPassedInGetAuth);
	...
	if (!authObjectFn) throw new Error("Clerk: clerkMiddleware() not detected. Make sure you have installed the clerkMiddleware in your root route.");
...
//#endregion
//#region node_modules/@clerk/react-router/dist/server/rootAuthLoader.js
/**
...
*/
var rootAuthLoader = async (args, handlerOrOptions) => {
...
//#endregion
export { clerkClient, clerkMiddleware, createClerkClient, getAuth, rootAuthLoader, verifyToken2 as verifyToken };
